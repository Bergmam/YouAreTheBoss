...
public class StatsHolderTests
{
    ...
    public void TestEquals()
    {
        ...
        StatsHolder[] otherStatsHolders = {
            new StatsHolder("AnotherTestHolder", 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, Color.black),
            new StatsHolder("TestHolder", 2.0f, 1.0f, 1.0f, 1.0f, 1.0f, Color.black),
            new StatsHolder("TestHolder", 1.0f, 2.0f, 1.0f, 1.0f, 1.0f, Color.black),
            new StatsHolder("TestHolder", 1.0f, 1.0f, 2.0f, 1.0f, 1.0f, Color.black),
            new StatsHolder("TestHolder", 1.0f, 1.0f, 1.0f, 2.0f, 1.0f, Color.black),
            new StatsHolder("TestHolder", 1.0f, 1.0f, 1.0f, 1.0f, 2.0f, Color.black),
            new StatsHolder("TestHolder", 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, Color.red)
        };
